            ...
            <div class="col-12 col-md-9 col-lg-9 bg-white py-2 rounded">
                <div class="row">
                    @if ($results->count()>0)
                        ...
                        @endforeach
                    @else
                        <img src="/images/undraw_empty.svg" class="img-fluid w-50 mx-auto" alt="Résultat Vide">
                        <h2 style="font-family: 'Nunito';" class="col-12 mt-3 h2 text-center">
                            <span class="text-primary font-weight-bold">Oops !</span>, on a pas trouvé ce que vous cherchez
                        </h2>
                    @endif
